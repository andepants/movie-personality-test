const getPersonalityType = async (keywords) => {
  ...
  const maxTokens = 200;
  let finalPrompt = `Give me a witty personality title for a human AND 3 sentences of a personality summary starting with "You are". Keywords: ${keywords}. Formatted as a JSON OBJECT: { "title" : "title", "summary": "summary" }`;
