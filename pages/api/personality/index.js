const getPersonalityType = async (keywords) => {
  ...
  const maxTokens = 200;
  let finalPrompt = `Give me a personality title AND 4 sentences of a personality summary starting with "You are". Keywords: ${keywords} Formatted { "title" :  "title", "summary": "summary" }`;
